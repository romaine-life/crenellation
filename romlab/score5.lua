...
local OUT = "D:/repos/crenellation/romlab/out/score5/"
...
emu.register_frame_done(function()
  ...
  if frame == 2039 then
    if STAMP then
      for x = 4, 13 do space:write_u8(cell(x,4), 0x41); space:write_u8(cell(x,13), 0x41) end
      for y = 4, 13 do space:write_u8(cell(4,y), 0x41); space:write_u8(cell(13,y), 0x41) end
    end
    snap("pre")
  end
