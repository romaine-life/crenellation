...
const PIPELINE: Stage[] = [
  ...
  },
  {
    ...
    state: 'part',
    detail: 'Started. A lifter recovers parameters, results and expressions, and every routine it produces is proved against the recompiled one on random machine states - 681 so far, exactly equal across 2,248 comparisons, with none held back. Control-flow structuring is next; 75% of the corpus needs only ordinary loops and branches.',
  },
];
...
const KNOWLEDGE = [
  { label: 'Decompiled — readable source, proved equal to the machine', n: 681, colour: C.done },
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 40, fontWeight: 600, lineHeight: 1, color: C.part }}>681</div>
