...
const KNOWLEDGE = [
  { label: 'Decompiled — readable source, proved equal to the machine', n: 740, colour: C.done },
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 40, fontWeight: 600, lineHeight: 1, color: C.part }}>740</div>
