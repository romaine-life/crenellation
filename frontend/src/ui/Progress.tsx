...
const PIPELINE: Stage[] = [
  ...
  },
  {
    ...
    state: 'part',
    detail: 'Started. A lifter recovers parameters, results and expressions, and every routine it produces is proved against the recompiled one on random machine states - 375 so far, exactly equal across 1,204 comparisons, and 87 held back because they were not. Control-flow structuring is next; 75% of the corpus needs only ordinary loops and branches.',
  },
];
...
const KNOWLEDGE = [
  { label: 'Decompiled — readable source, proved equal to the machine', n: 375, colour: C.done },
  { label: 'Named by hand, purpose established', n: 39, colour: C.part },
  { label: 'Described from evidence — callers, callees, hardware touched', n: 181, colour: '#2d4f6b' },
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 40, fontWeight: 600, lineHeight: 1, color: C.part }}>375</div>
